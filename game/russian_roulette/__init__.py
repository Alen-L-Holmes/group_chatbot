...
set_sign = on_command("重置轮盘签到", permission=GROUP, priority=5, block=True)
...
accept = on_command(
    "接受对决", aliases={"接受决斗", "接受挑战", "接受"}, permission=GROUP, priority=5, block=True
)

refuse = on_command(
    "拒绝对决", aliases={"拒绝决斗", "拒绝挑战", "拒绝"}, permission=GROUP, priority=5, block=True
)
